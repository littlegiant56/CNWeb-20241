...
export default function Layout() {
  ...
  const [doesNotificationContainerOpen, setDoesNotificationContainerOpen] =
    useState(false);
  ...
  const isProfileOrFriendRequestPage =
    ...
    >
      ...
      <Container className="p-0 pt-2 position-relative mt-3" fluid>
        {!isProfileOrFriendRequestPage && (
          <Container
            className="p-0 position-fixed mt-4"
            style={{ width: "20%", top: "75px", left: "0px" }}
          >
            <ProfileCard />
          </Container>
        )}
        ...
        {!isProfileOrFriendRequestPage && (
          <Container
            className="p-0 position-fixed mt-4"
            style={{ width: "20%", top: "75px", right: "0px" }}
          >
            <FriendList
