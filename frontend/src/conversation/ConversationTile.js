...
export function ConversationTile({
  ...
  return (
    userProfile && (
      <Container className="d-flex p-0" onClick={handleClickConversation}>
        <img
        ...
        <Container className="d-flex">
          <Container className="p-0">
            ...
            >
              <p className="me-1">
                {conversation.lastMessage.sentUserId ===
          ...
          {!conversation.lastMessage.isRead &&
            conversation.lastMessage.sentUserId !==
              localStorage.getItem("userId") && (
              <Container
                className="bg-primary text-white rounded-2 p-1 align-self-center"
