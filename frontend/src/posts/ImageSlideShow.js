...
export default function ImageSlideShow({ images }) {
  ...
  return (
    <Container className="z-1">
      <Button
        className="p-0 border-0 align-self-center ms-3 me-2"
        style={{ width: "30px", background: "black" }}
      ...
      <Link to={`image`} state={{ imagePosition: imagePosition }}>
        <Image
          className="object-fit-scale me-2"
          src={images[imagePosition]}
          style={{ maxHeight: "50vh", maxWidth: "40%" }}
        />
      </Link>
      {imagePosition + 1 < images.length && (
        <Link to={`image`} state={{ imagePosition: imagePosition + 1 }}>
          <Image
            ...
            src={images[imagePosition + 1]}
            style={{ maxHeight: "50vh", maxWidth: "40%" }}
          />
        </Link>
      )}
      <Button
        className="p-0 border-0 align-self-center me-2 ms-2"
        style={{ width: "30px", background: "black" }}
